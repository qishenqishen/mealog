/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker/env.d.ts` (hash: 62c1e90a05c866437830398f7caef9bf)
// Runtime types generated with workerd@1.20260907.1 2026-09-08
interface __BaseEnv_Env {
	AI: Ai;
	ASSETS: Fetcher;
	INSIGHTS_QUOTA: DurableObjectNamespace<import("./index").InsightsQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "InsightsQuota";
	}
